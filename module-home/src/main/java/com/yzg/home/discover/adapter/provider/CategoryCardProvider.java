...
import com.yzg.home.databinding.HomeItemCategoryCardViewBinding;
import com.yzg.home.discover.adapter.CategoryItemAdapter;
...
//            binding.tvTitle.setText(cardBean.getData().getHeader().getTitle());
            binding.tvTitle.setText("测试");
            binding.tvActionTitle
                .setText("测试1");
            ArrayList<SquareCard> dataList = new ArrayList<>();
            if (cardBean.getData()!=null &&cardBean.getData().getItemList()!=null) {
