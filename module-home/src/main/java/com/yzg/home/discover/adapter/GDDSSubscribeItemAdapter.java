...
import com.yzg.home.databinding.HomeItemGddsSubsItemBinding;
 ...
 * @since 2020-02-15
 */
public class GDDSSubscribeItemAdapter
        extends BaseQuickAdapter<SquareCard, BaseViewHolder> {

    public GDDSSubscribeItemAdapter(int layoutResId) {
        super(layoutResId);
    }
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder,
        ...
        HomeItemGddsSubsItemBinding binding =
