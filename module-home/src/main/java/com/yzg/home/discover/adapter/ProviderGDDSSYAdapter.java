...
import com.yzg.home.discover.adapter.provider.GDDSSYProvider;
 ...
 * @since 2020-02-15
 */
public class ProviderGDDSSYAdapter
        extends BaseProviderMultiAdapter<BaseCustomViewModel> {

    public ProviderGDDSSYAdapter() {
        super();
        // 注册具体业务提供者
        addItemProvider(new GDDSSYProvider());
