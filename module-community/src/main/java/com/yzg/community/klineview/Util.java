package com.yzg.community.klineview;
...
import com.yzg.community.klineview.model.KModel;
...
public class Util {
    ...
    private static SimpleDateFormat sFormat4 = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss", Locale.getDefault());
